          ...
          <div class="aside-menu pe-2 my-auto flex-column-fluid">
            <nav class="flex-grow-1 h-100" id="page-navbar">
              ...
              <ul class="nav flex-column collapse-group collapse d-flex pt-4">
                ...
                <li class="nav-item">
                  <a href="selesai.php.php" class="nav-link d-flex align-items-center text-truncate ">
                    <span class="sidebar-icon">
                      <i class="fas fa-briefcase fs-5"></i>
                    </span>
                    <span class="sidebar-text">Laporan Selesai</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="proses.php" class="nav-link d-flex align-items-center text-truncate ">
                    <span class="sidebar-icon">
                      <i class="fas fa-file-invoice fs-5"></i>
                    </span>
                    <span class="sidebar-text">Laporan Belum selesai</span>
                  </a>
                </li>
              ...
              <div class="dropdown-menu mt-0 p-0 dropdown-menu-end overflow-hidden">
                ...
                <div class="position-relative overflow-hidden p-4 bg-primary-subtle">
                  <div class="position-relative">
                    ...
                    <p class="text-body-tertiary small mb-0 lh-1">Petugas</p>
                  </div>
                </div>
                <div class="p-2">
                  <a href="ganti_pass.php" class="dropdown-item">
                    <i class="bi bi-person-circle opacity-75 fs-5 align-middle me-2"></i>Ganti Password</a>
